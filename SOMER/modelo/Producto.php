...
private $nimagen=0;
  ...
  function getImagen(){
	...
	$sQuery="";
	$nAfectados=-1;
		if ($this->nmodelo=="" || $this->nlinea == "" || $this->nestilo == "" $this->nplantilla=="" || $this->nsuela=="" || $this->ncorte =="" || $this->nmontado =="" || $this->ncasquillo=="" || $this->ncolor=="" || $this->nprecio=="" || $this->nimagen=="")
			...
			if ($oAccesoDatos->conectar()){
				...
				*/
				...
				$sQuery = $sQuery."
					INSERT INTO alumno ( nmodelo, nlinea, nestilo, nplantilla, nsuela, ncorte, nmontado, ncasquillo, ncolor, nprecio, nImagen)
					VALUES (".$this->nmodelo.",".$this->nlinea.",".$this->nestilo.", ".$this->nplantilla.", "$this->nsuela");";
                   error_log($sQuery,0);
	...
	$nAfectados=-1;
		if ($this->smodelo=="")
			...
			if ($oAccesoDatos->conectar()){
				...
				$sQuery = "DELETE FROM alumno WHERE nmodelo = '".$this->nmodelo."'; ";
	...
	$oProd=null;
		if ($oAccesoDatos->conectar()){
		 	$sQuery = "SELECT t1.nmodelo, t1.nlinea, t1.sNombre, t1.sApePat,
